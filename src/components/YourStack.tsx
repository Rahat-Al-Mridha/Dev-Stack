...
//   console.log(selectedTechnologies, "Fro9m technologies");
...
//           Your Stack
//         </h2>
//         <h6 className=" text-base text-sm text-gray-400">
//           No technologies selected yet.
//         </h6>
...
//       {
//         selectedTechnologies.map((technology: Itechnologies, ind: number) => {
//           return <YourStackCard key={ind} technology={technology} selectedTechnologies={selectedTechnologies} setSelectedTechnologies={setSelectedTechnologies} ></YourStackCard>
//         })
//       }
